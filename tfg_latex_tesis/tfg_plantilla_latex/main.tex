...
\input{capitulos/1introduccion.tex}
\input{capitulos/2estado_arte.tex}
\input{capitulos/3analisis_metodologia.tex}
\input{capitulos/4diseno_sistema.tex}
\input{capitulos/5implementación.tex}
\input{capitulos/6pruebas_y_validación.tex}
\input{capitulos/7resultados_y_discusión.tex}
\input{capitulos/8conclusion.tex}
...
\input{anexos/anexoA_db_schema.tex} 
\input{tfg_plantilla_latex/anexos/anexo_oauth_fitbit}
\input{tfg_plantilla_latex/anexos/anexo_validacion_pruebas}
\input{tfg_plantilla_latex/anexos/anexo_umbrales_alertas}
\input{anexos/anexoB_implementacion.tex}
\input{tfg_plantilla_latex/anexos/anexoB_implementacion_buena}
\input{tfg_plantilla_latex/anexos/anexo_pruebas}
